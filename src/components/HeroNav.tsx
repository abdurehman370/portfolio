...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`navShell ${isScrolled ? 'navShell--scrolled' : 'navShell--top'}`}>
      <div className="max-w-7xl navPill">
...
export const Hero: React.FC = () => {
  ...
  const visibleSkills = showAllSkills ? hero.skills : hero.skills.slice(0, 6);
  const hiddenCount = Math.max(0, hero.skills.length - 6);

  return (
    <section className="heroSection">
      <div className="max-w-7xl heroFrame">
        <div className="twoCol">
          ...
          >
            ...
            <h1 className="h1 mb-6">
              Full stack engineer providing software that feels <span className="gradient-text">sharp, useful, and production-ready</span>
            </h1>
              ...
              <div className="relative">
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  ...
                  <a
                    ...
                    href={`${import.meta.env.BASE_URL}resume/Abdur_Rehman_Updated_CV_.pdf`}
                    target="_blank"
                    rel="noreferrer"
                  >
