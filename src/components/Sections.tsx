          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <RevealOnScroll delay={0.1}>
                <a href={`mailto:${contact.email}`} className="flex items-center gap-4 sm:gap-6 group min-w-0">
              ...
              <RevealOnScroll delay={0.2}>
                <a href={contact.linkedin} target="_blank" rel="noreferrer" className="flex items-center gap-4 sm:gap-6 group min-w-0">
                  <div className="iconBtn shrink-0" style={{ width: '3.3rem', height: '3.3rem' }}>
              ...
              <RevealOnScroll delay={0.3}>
                <a href={contact.github} target="_blank" rel="noreferrer" className="flex items-center gap-4 sm:gap-6 group min-w-0">
                  <div className="iconBtn shrink-0" style={{ width: '3.3rem', height: '3.3rem' }}>
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
